...
namespace qb
{
    const static std::unordered_map<SdfOperationType, std::string> s_SdfOperationNames = 
    {
        ...
        {SdfOperationType_RoundedCone, "roundedcone"},
        {SdfOperationType_Cylinder, "cylinder"},
        {SdfOperationType_RoundedCylinder, "roundedcylinder"},
        {SdfOperationType_Octahedron, "octahedron"},
        {SdfOperationType_Pyramid, "pyramid"},
