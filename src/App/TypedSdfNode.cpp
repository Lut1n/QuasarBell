...
MAKE_GEOMETRY_NODE_CREATOR(Repetition, qb::SdfOperationType_Repetition)
MAKE_GEOMETRY_NODE_CREATOR(Twist, qb::SdfOperationType_Twist)
MAKE_GEOMETRY_NODE_CREATOR(Bend, qb::SdfOperationType_Bend)
MAKE_GEOMETRY_NODE_CREATOR(Elongation, qb::SdfOperationType_Elongation)
MAKE_GEOMETRY_NODE_CREATOR(Symmetry, qb::SdfOperationType_Symmetry)
MAKE_GEOMETRY_NODE_CREATOR(Displacement, qb::SdfOperationType_Displacement)
MAKE_GEOMETRY_NODE_CREATOR(Texturing, qb::SdfOperationType_Texturing)
MAKE_GEOMETRY_NODE_CREATOR(HighResSdfOutput, qb::SdfOperationType_HighResOutput)
MAKE_GEOMETRY_NODE_CREATOR(VoxelOutput, qb::SdfOperationType_Voxel)
