...
MAKE_IMAGE_NODE_CREATOR(ImageSin, qb::ImageOperationType_Sin)
...
MAKE_IMAGE_NODE_CREATOR(ImageMin, qb::ImageOperationType_Min)
MAKE_IMAGE_NODE_CREATOR(ImageMax, qb::ImageOperationType_Max)
...
MAKE_IMAGE_NODE_CREATOR(SimplexNoise, qb::ImageOperationType_SimplexNoise)
MAKE_IMAGE_NODE_CREATOR(VoronoiNoise, qb::ImageOperationType_Voronoi)
MAKE_IMAGE_NODE_CREATOR(Mandelbrot, qb::ImageOperationType_Mandelbrot)
...
MAKE_IMAGE_NODE_CREATOR(SphericalCoord, qb::ImageOperationType_SphericalCoord)
...
MAKE_IMAGE_NODE_CREATOR(TimeInput, qb::ImageOperationType_Time)
